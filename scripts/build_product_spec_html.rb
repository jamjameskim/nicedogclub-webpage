...
template = <<~HTML
  ...
  <head>
    ...
    <title>Nice Dog Club — 서비스 상세 기획안</title>
    <style>
  ...
  <body>
    ...
    <header class="topbar"><div class="topbar-in"><div class="brand"><span class="mark">N</span><span class="name">Nice Dog Club</span></div><span class="version">SPEC v1.2</span><div class="tools"><input id="search" class="search" type="search" placeholder="문서에서 검색 (예: 쓰레기통, 알림)" aria-label="문서 검색"><button id="expand">전체 펼침</button><button onclick="window.print()">인쇄 / PDF</button></div></div></header>
